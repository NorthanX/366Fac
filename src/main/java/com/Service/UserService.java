...
//        System.out.println("userservice login success");
     ...
     * 默认注册时一定输入邮箱
     */
    public Map<String, String> register(String username, String password, String mail,String code) {
        Map<String, String> map = new HashMap<>();
        map.put("reg","fail");
...
//        System.out.println("user Service "+user.getUserpic());
    ...
    public Map<String,String> changePassword(User user,String code,String password,String mail){
        Map<String,String> map=new HashMap<>();
        ...
        ValueOperations valueOperations = redisTemplate.opsForValue();
        if (!code.equals(valueOperations.get(mail))){
            String msg = "验证码错误";
            map.put("msg",msg);
            return map;
        }
